...
export default function Post({ postData }: PostProps) {
  return (
    <Layout>
      <div className="flex flex-col items-center space-y-4 p-4 md:space-y-8">
        {/* Profile Picture Placeholder */}
        <div className="h-32 w-32 rounded-full bg-gray-300 md:h-48 md:w-48"></div>
        ...
        <div className="w-full space-y-2 md:space-y-4">
          ...
          <p>
            ...
            {postData.attended_event}
          </p>
          <p>
            <span className="font-semibold">Summary:</span>{' '}
            {postData.linkedin_summary_gpt4}
          </p>
          <p>
            <span className="font-semibold">Career Highlight:</span>{' '}
            {postData.linkedin_career_highlight_gpt4}
          </p>
        </div>
